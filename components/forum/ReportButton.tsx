...
import { reportContent } from "@/app/actions/forum";
...
export function ReportButton({ postId, variant = "ghost", className, showIconOnly = false }: ReportButtonProps) {
    ...
    return (
        <div className={className}>
            ...
            >
                ...
                {!showIconOnly && <span className="uppercase font-black text-[10px]">Denunciar</span>}
            </Button>
