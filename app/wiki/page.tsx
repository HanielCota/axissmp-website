    ...
    return (
        <main className="bg-background relative min-h-screen overflow-hidden">
            ...
            <div className="pointer-events-none fixed inset-0">
                <div className="bg-brand-blue/5 absolute top-[-10%] left-[-10%] h-[600px] w-[600px] rounded-full blur-[120px]" />
                <div className="bg-brand-orange/5 absolute top-[20%] right-[-10%] h-[500px] w-[500px] rounded-full blur-[100px]" />
            ...
            <div className="relative mx-auto max-w-7xl px-6 pt-32 pb-20 md:px-8">
                ...
                <div className="relative z-10 mb-20 space-y-8 text-center">
                    <motion.div
                        ...
                        className="bg-brand-dark/5 text-brand-dark/60 mb-4 inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-bold"
                    >
                    ...
                    >
                        <div className="bg-brand-dark/5 group-hover:bg-brand-blue/20 absolute inset-0 rounded-full blur-xl transition-all duration-500" />
                        <div className="shadow-brand-dark/5 border-brand-dark/5 focus-within:border-brand-blue/50 relative flex items-center rounded-2xl border bg-white p-2 shadow-xl transition-all">
                            <Search className="text-brand-dark/40 ml-4" size={24} />
                            <Input
                    ...
                    >
                        <span className="text-brand-dark/30 text-xs font-bold tracking-widest uppercase">
                            Em Alta
                        </span>
                        <div className="flex max-w-2xl flex-wrap justify-center gap-2">
                            {popularArticles.map((article, index) => (
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="border-brand-dark/5 text-brand-dark/70 hover:text-brand-orange hover:border-brand-orange/30 hover:shadow-brand-orange/5 group flex items-center gap-2 rounded-full border bg-white/50 px-4 py-2 text-sm font-medium backdrop-blur-sm transition-all duration-300 hover:bg-white hover:shadow-lg"
                                >
                                    <span className="bg-brand-dark/20 group-hover:bg-brand-orange h-1.5 w-1.5 rounded-full transition-colors" />
                                    {article}
                                </motion.a>
                            ))}
                        </div>
                ...
                <div className="grid auto-rows-fr gap-6 md:grid-cols-3">
                    {categories.map((category, index) => (
                        <motion.a
                            ...
                            className={`group border-brand-dark/5 hover:shadow-brand-dark/5 relative overflow-hidden rounded-3xl border bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${category.border} ${category.grid}`}
                        >
                            <div
                            ...
                            <h3 className="text-brand-dark group-hover:text-brand-blue mb-2 text-2xl font-bold transition-colors">
                                {category.title}
                            </h3>
                            <p className="text-brand-dark/60 mb-6 leading-relaxed font-medium">
                                {category.description}
                            </p>

                            <div className="text-brand-dark/40 group-hover:text-brand-blue flex items-center gap-2 text-sm font-bold transition-colors">
