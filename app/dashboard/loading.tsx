        ...
        <div className="min-h-screen bg-brand-light dark:bg-[#0a0a0a] text-slate-900 dark:text-white transition-colors duration-300">
            <div className="relative z-10 mx-auto max-w-7xl px-6 py-12 md:py-20">
                ...
                <div className="mb-12 flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
                    <div>
                        <div className="mb-4 h-4 w-24 animate-pulse rounded bg-slate-200 dark:bg-white/10" />
                        <div className="mb-2 h-12 w-72 animate-pulse rounded bg-slate-200 dark:bg-white/10" />
                        <div className="h-5 w-48 animate-pulse rounded bg-slate-200 dark:bg-white/10" />
                    </div>
                    <div className="h-12 w-36 animate-pulse rounded-2xl bg-slate-200 dark:bg-white/10" />
                </div>
